  ...
  <div class="mx-auto col-md-12 modified-continer">
    <div class="elBG panel">
      ...
      >
        ...
        <div class="rowFields mx-auto row">
          <div class="col-lg-3">
            <p class="textLabel">Overtime-In:</p>
          </div>
          <div class="col-lg-9">
            <div class="input-group">
              <date-picker
                ...
                v-b-tooltip.hover
                title="Overtime-In"
                placeholder="Overtime-In"
                autocomplete="off"
                @input="updateOverTimeHour"
                v-validate="'required'"
                name="time_in"
              ></date-picker>
            </div>
        ...
        <div class="rowFields mx-auto row">
          <div class="col-lg-3">
            <p class="textLabel">Overtime-Out:</p>
          </div>
          <div class="col-lg-9">
            <div class="input-group">
              <date-picker
        ...
        <div class="rowFields mx-auto row" v-if="apply.with_break == 'Yes'">
          <div class="col-lg-3">
        ...
        <div class="rowFields mx-auto row">
          <div class="col-lg-3">
            <p class="textLabel">Overtime Hours:</p>
          </div>
          <div class="col-lg-9">
    ...
    <div id="to-approve">
      <div>
        ...
        <table class="my-table">
          ...
          <tr>
            <td class="my-td tr-even">With break:</td>
            <td class="my-td tr-even">{{ apply.with_break }}</td>
          </tr>
          <tr>
            <td class="my-td">Break hours:</td>
            <td class="my-td">{{ apply.break_hours }}</td>
          </tr>
          <tr>
            <td class="my-td tr-even">Total no. of hours:</td>
            <td class="my-td tr-even">{{ apply.total_hours }}</td>
          </tr>
          <tr>
            <td class="my-td">Date filed:</td>
          ...
          <tr>
            <td class="my-td tr-even">Reason:</td>
            <td class="my-td values tr-even">
              {{ apply.reason }}
            </td>
          </tr>
        </table>
...
export default {
  ...
  methods: {
    ...
    openModalApprovers(item) {
      ...
      this.$http
        .get("api/getApprover/" + this.user.id + "/ot/" + item.id)
        .then(function(response) {
    ...
    cancelApplication() {
      ...
      swal({
        ...
        if (approve) {
          ...
          this.tblisBusy = true;
          this.$http
            .post("api/OverTime/cancelApp", this.item_edit)
            .then(response => {
              console.log(response.body);
              this.items = response.body;
              this.totalRows = this.items.length;
