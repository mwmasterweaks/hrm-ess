    ...
    <div class="elBG panel">
          ...
          >
            ...
            <template v-slot:cell(actions)="row">
              ...
              <button
                ...
                @click="sendCredentials(row.item)"
              >
              ...
              <div class="col-md-5" v-if="item_selected.length > 0">
                <div style="margin-left:-50px">
                  ...
                  <button
                    ...
                    title="Add Approver to all selected employee"
      ...
      >
        ...
        <div>
          ...
          <div class="rowFields mtu mx-auto row">
            <div class="col-lg-3">
              <p class="textLabel">
                <b>Multiple Time Update</b>
              </p>
            </div>
            <div class="col-lg-1">
              <p class="textLabel"></p>
            ...
            <div class="col-lg-3">
              <b-form-timepicker
                v-model="groupTimeIn"
                locale="en"
                title="Update all time in schedule"
                @input="gti_change"
                :hour12="false"
              ></b-form-timepicker>
            </div>
            <div class="col-lg-3">
              <b-form-timepicker
                v-model="groupTimeOut"
                locale="en"
                title="Update all time out schedule"
                @input="gto_change"
                :hour12="false"
              ></b-form-timepicker>
            </div>
