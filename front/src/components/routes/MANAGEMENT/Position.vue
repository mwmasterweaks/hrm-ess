    ...
    <div class="elBG panel">
      ...
      >
        ...
        <div class="rowFields mx-auto row">
          <div class="col-lg-3">
            <p class="textLabel">Employee Position:</p>
          </div>
          <div class="col-lg-9">
            <input
              type="text"
            ...
            <small class="text-danger pull-left" v-show="errors.has('name')"
              >Employee Position is required.</small
            >
          </div>
        </div>
        ...
        <div class="rowFields mx-auto row">
          ...
          <div class="col-lg-9">
            <input
              ...
              class="form-control"
              v-b-tooltip.hover
              title="Description of the Position"
              v-validate="'required'"
      ...
      <b-modal
        ...
        :footer-text-variant="' elClr'"
        size="xl"
        title="Update Employee Position"
        @ok="handleOk"
      >
        <!-- form -->
        <div class="rowFields mx-auto row">
...
export default {
  ...
  created() {
    ...
    this.items = this.$global.getPosition();
        ...
        if (result) {
          ...
          swal({
            ...
            if (update) {
              ...
              this.$http
                .put("api/Position/" + this.item_edit.id, this.item_edit)
                .then(response => {
    ...
    btnAdd() {
      this.$validator.validateAll().then(result => {
        if (result) {
          ...
          this.$http
            .post("api/Position", this.item_add)
            .then(response => {
    ...
    btnDelete() {
      swal({
        ...
        if (willDelete) {
          ...
          this.tblisBusy = true;
          this.$http
            .delete("api/Position/" + this.item_edit.id)
            .then(response => {
              this.$bvModal.hide("modalEdit");
